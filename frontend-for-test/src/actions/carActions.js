...
export const updateCarFromDatabase = (user) => dispatch => {
    return new Promise((resolve, reject) => {
        Axios.post("https://backend-for-test.herokuapp.com/api/accounts/updated-car", user)
            .then(res => {
                dispatch({
...
export const updateSharedCars = (user) => dispatch => {
    Axios.post("https://backend-for-test.herokuapp.com/api/accounts/update-shared-cars", user)
        .then(res => {
            dispatch({
